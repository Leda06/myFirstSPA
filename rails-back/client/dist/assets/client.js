...
;define('client/config/environment', [], function() {
          ...
          var exports = {
            'default': {"modulePrefix":"client","environment":"development","rootURL":"/","locationType":"auto","EmberENV":{"FEATURES":{},"EXTEND_PROTOTYPES":{"Date":false}},"APP":{"name":"client","version":"0.0.0+db29f961"},"exportApplicationGlobal":true}
          };
...
;
          if (!runningTests) {
            require("client/app")["default"].create({"name":"client","version":"0.0.0+db29f961"});
          }
